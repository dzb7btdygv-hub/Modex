...
`modex-icon-app-1024.png` and `macos/modex.icns` are generated app icon assets. The packaged app icon uses the full-color transparent gradient mark from the current Modex logo.
